...
public class MediaController {
     ...
     * @param outputPath the outputPath path where compressed video is eventually saved
     ...
     */
    @TargetApi(16)
    public boolean compressVideo(final String sourcePath, String outputPath, int outWidth, int outHeight, int outBitrate) {
        ...
        try {
            ...
            extractor.setDataSource(sourcePath, new HashMap<String, String>());
            ...
            if (mediaMuxer != null) {
                try {
                    ...
                    Log.e(TAG, "finishMovie Exception", e);
                }
            }
        }

        //inputFile.delete();
//        Log.e(TAG, "output:" + cacheFile.getAbsolutePath());
        return true;
    }
}